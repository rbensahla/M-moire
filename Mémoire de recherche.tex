...
\begin{document}
   ...
   \section{Introduction}
	...
	L'approche de Gatheral et Rosenbaum est de partir du principe que l'on accès à différentes observations du processus de volatilité $\sigma_t$ et de découper les instants de volatilités sur $[0;T]$ comme suit : $\sigma_0, \ldots, \sigma_\Delta, \dots, \sigma_k\Delta, \dots, k \in {[0,  N]}$, où $N = \left\lfloor {T/\Delta} \right\rfloor$.
